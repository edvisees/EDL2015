...
def init_corenlp_command(corenlp_path, memory, properties):
    ...
    corenlp_jar = properties['corenlp_jar'] if 'corenlp_jar' in properties else "stanford-corenlp-?.?.?.jar"
    corenlp_models_jar = properties['corenlp_models_jar'] if 'corenlp_models_jar' in properties else "stanford-corenlp-?.?.?-models.jar"

    jars = [corenlp_jar]
    jars.append(corenlp_models_jar)
    #"xom.jar",
    #"joda-time.jar",
    #"jollyday.jar",
...
class StanfordCoreNLP:
    ...
    def _parse(self, text):
        ...
        self.corenlp.sendline(to_send.encode('utf-8'))
